...
# rk:autoresearch — Autonomous Optimization Loop
...
|-----------|-------------|
| Subjective goals ("make it cleaner") | `rk:cook` |
| Bug fixing with known root cause | `rk:fix` or `rk:debug` |
| One-shot tasks, no repetition needed | `rk:cook` |
| No mechanical metric to measure progress | `rk:cook --interactive` |
