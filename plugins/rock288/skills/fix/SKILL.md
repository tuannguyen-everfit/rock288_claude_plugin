...
**Always activate:** `rk:debug` (all workflows)
**Conditional:** `rk:problem-solving`, `rk:sequential-thinking`, `rk:brainstorm`, `rk:context-engineering`
...
- `references/workflow-quick.md` - Quirk: debug → fix → review
