...
Activate `rk:debug` skill. Launch 2-3 `Explore` subagents in parallel:
```
...
|------|------------------|
| 1 | `rk:debug`, parallel `Explore` subagents for investigation |
| 2 | `researcher` (runs parallel with step 1) |
| 3 | `rk:brainstorm` |
| 4 | `planner` |
| 5 | `rk:problem-solving`, `rk:sequential-thinking`, `rk:context-engineering`, parallel `Bash` |
| 6 | `tester` |
| 7 | `code-reviewer` |
