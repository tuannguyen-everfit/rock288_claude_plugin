...
### Step 1: Debug
Activate `rk:debug` skill. Find root cause quickly. Verify the root cause with multiple `Explore` subagents in parallel.
...
Prompt: "Quick review of fix for [issue]. Cherk: correctness, security, no regressions. Score X/10."
