...
### Step 2: Summarize the plans and document them with `/rk:journal` slash command
...
- Stage and commit the changes (Use `/rk:git cm` slash command)
- Commit and push the changes (Use `/rk:git cp` slash command)
