...
### Step 2: Summarize the plans and document them with `/rk:journal` skill invocation
...
- Stage and commit the changes (Use `/rk:git` for commit flow)
- Commit and push the changes (Use `/rk:git` for push flow)
