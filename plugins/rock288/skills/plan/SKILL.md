...
|------------|-----------|---------|
| `/rk:plan archive` | `references/archive-workflow.md` | Archive plans + write journal entries |
| `/rk:plan red-team` | `references/red-team-workflow.md` | Adversarial plan review with hostile reviewers |
| `/rk:plan validate` | `references/validate-workflow.md` | Validate plan with critical questions interview |
