...
- Otherwise use `rk:repomix` to generate fresh codebase summary
- Use `/rk:scout` or `/rk:scout ext` to find relevant files
- Use `rk:docs-seeker` skill for package/plugin documentation
