...
1. **Screenshots provided** → Use `rk:ai-multimodal` skill for detailed context analysis
2. **Videos provided** → Use `rk:ai-multimodal` video-analysis for comprehensive context
