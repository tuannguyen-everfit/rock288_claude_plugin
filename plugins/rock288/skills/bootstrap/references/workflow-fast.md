...
2. If no logo provided: generate with `rk:ai-multimodal` skill
3. Screenshot wireframes with `rk:chrome-devtools` → save to `./docs/wireframes/`
...
Activate **rk:plan** skill: `/rk:plan --fast <requirements>`
